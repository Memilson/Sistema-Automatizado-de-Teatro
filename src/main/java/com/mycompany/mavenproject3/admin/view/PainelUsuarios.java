...
public class PainelUsuarios extends VBox {
    ...
    public PainelUsuarios() {
        ...
        Button promover = new Button("Promover para Admin");
        Button alterar = new Button("Alterar Assinatura");

        atualizar.setOnAction(e -> UsuarioAdminControllerFX.carregarUsuarios(tabela));
        promover.setOnAction(e -> UsuarioAdminControllerFX.promoverUsuario(tabela));
        alterar.setOnAction(e -> UsuarioAdminControllerFX.alterarPlano(tabela));

        HBox botoes = new HBox(20, atualizar, promover, alterar);
